...
from lerobot.policies.smolvla4.smolvlm import SmolVLM
...
class SmolVLA4Policy(PreTrainedPolicy):
    """Wrapper class around VLAFlowMatching model to train and run inference within LeRobot."""

    config_class = SmolVLA4Config
    name = "smolvla3"

    def __init__(
        self,
        config: SmolVLA4Config,
...
class VLAFlowMatching(nn.Module):
    ...
    def __init__(self, config: SmolVLA4Config):
        super().__init__()
        self.config = config
