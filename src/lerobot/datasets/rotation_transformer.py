...
from lerobot.datasets.pose_util import rot6d_to_mat, mat_to_rot6d
...
def test():
    ...
    rotvec = np.random.uniform(-2*np.pi,2*np.pi,size=(1,3))
    print(rotvec)
    ...
    print(Rotation.from_rotvec(new_rotvec).as_matrix())
